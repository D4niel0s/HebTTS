...
def main():
    ...
    text_tokens = "/cs/labs/adiyoss/amitroth/valle/examples/libritts/data/tokenized/unique_text_tokens.k2symbols"
    text_collater = get_text_token_collater(text_tokens)

    if args.audio_tokenizer == "encodec":
        print("using encodec")
