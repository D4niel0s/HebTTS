...
class TtsDataModule:
    ...
    def train_cuts(self) -> CutSet:
        ...
        return load_manifest_lazy(
            self.args.manifest_dir / "libtts_cuts_train.jsonl.gz"
        )

    @lru_cache()
    def dev_cuts(self) -> CutSet:
        logging.info("About to get dev cuts")
        return load_manifest_lazy(self.args.manifest_dir / "libtts_cuts_dev.jsonl.gz")

    @lru_cache()
    def test_cuts(self) -> CutSet:
        logging.info("About to get test cuts")
        return load_manifest_lazy(self.args.manifest_dir / "libtts_cuts_test.jsonl.gz")
