...
class TtsDataModule:
    ...
    def train_dataloaders(
        ...
        # @amitroth added this line to prevent oom from long tokens
        if True:
    ...
    def valid_dataloaders(self, cuts_valid: CutSet) -> DataLoader:
        ...
        if True:
            ...
            logging.info("filtered")
            print("filtered nby length for valid!")
            # print(f"filtered! {len(cuts_train.to_eager())} - {length_before_filter}")
    ...
    def test_dataloaders(self, cuts: CutSet) -> DataLoader:
        ...
        if True:
            ...
            logging.info("filtered")
            print("filtered by length for test!")
            # print(f"filtered! {len(cuts_train.to_eager())} - {length_before_filter}")
    ...
    def train_cuts(self) -> CutSet:
        ...
        return load_manifest_lazy(
            self.args.manifest_dir / "libritts_cuts_train.jsonl.gz"
        )

    @lru_cache()
    def dev_cuts(self) -> CutSet:
        logging.info("About to get dev cuts")
        return load_manifest_lazy(self.args.manifest_dir / "libritts_cuts_dev.jsonl.gz")

    @lru_cache()
    def test_cuts(self) -> CutSet:
        logging.info("About to get test cuts")
        return load_manifest_lazy(self.args.manifest_dir / "libritts_cuts_test.jsonl.gz")
