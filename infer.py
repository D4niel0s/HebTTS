...
def infer(checkpoint_path, output_dir, texts, prompt_text, prompt_audio, top_k=50, temperature=1, args=None):
    ...
    #TODO: remove this
    decoded_frames = audio_tokenizer.decode(encoded_frames[0][0].transpose(2, 1))
...
def get_args():
    ...
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="/home/yandex/APDL2425a/group_6/Documents/HebTTS/valle/exp/valle_dev/checkpoint-120000.pt",
