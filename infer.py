...
def get_args():
    ...
    parser.add_argument(
        "--text",
        type=str,
        default="קיצר אז אני אומר מלא טקסט וזה, ואז המודל אמור כזה להקריא אותו",
    ...
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="/home/yandex/APDL2425a/group_6/Documents/HebTTS/valle/exp/valle_dev/checkpoint-210000.pt",
