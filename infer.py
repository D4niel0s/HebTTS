...
def get_args():
    ...
    parser.add_argument(
        "--text",
        type=str,
        default="היי לכולם, קוראים לי דניאל | ואם אתה משפר את איכות החיזוי, אתה יכול להציל חיי אדם | הדינוזאור התעורר משנת חורף ודרש אספרסו עם נגיעה של קינמון וזיכרונות משנות השמונים",
