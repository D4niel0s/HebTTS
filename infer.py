...
def get_args():
    ...
    parser.add_argument(
        "--text",
        type=str,
        default="אוי לא נפלו לי כל הספוגניות בסדר אתם יודעים איך אני זה קורה לי כל שנה ואז אני עושה את הפרומפט ממש ממש יותר הרבה יותר ארוך כי אני חושב שהמודל הזדיין ועכשיו הוא יודע לענות רק על טקסט ארוך",
    ...
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="/home/yandex/APDL2425a/group_6/Documents/HebTTS/valle/exp/valle_dev/checkpoint-30000.pt",
