...
def get_args():
    ...
    parser.add_argument(
        "--text",
        type=str,
        default="היי לכולם, קוראים לי דניאל | ואם אתה משפר את איכות החיזוי, אתה יכול להציל חיי אדם | ​הדינוזואר התעורר משנת חורפ ודרש אספרסו עם נגיעה של קינמונ וזיכרונות משנות השמונים",
