...
def get_args():
    ...
    parser.add_argument(
        "--text",
        type=str,
        default="היי לכולם, קוראים לי דניאל | ואם אתה משפר את איכות החיזוי, אתה יכול להציל חיי אדם | ​הדינוזואר התעורר משנת חורף ודרש אספרסו עם נגיעה של קינמון וזיכרונות משנות ה-80.",
    ...
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="/home/yandex/APDL2425a/group_6/Documents/HebTTS/valle/exp/valle_dev/checkpoint-130000.pt",
