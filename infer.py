...
def get_args():
    ...
    parser.add_argument(
        "--text",
        type=str,
        default="אוקיי עכשיו זה משפט די קצרצר | וזה משפט ממש ממש ארוך, שמכיל מלא מלא מילים, כדי לבדוק שהמודל יודע לייצר גם כן משפטים ארוכים, ולא רק קצרים",
    ...
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="/home/yandex/APDL2425a/group_6/Documents/HebTTS/valle/exp/valle_dev/checkpoint-200000.pt",
